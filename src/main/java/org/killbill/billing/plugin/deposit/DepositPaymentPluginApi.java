...
public class DepositPaymentPluginApi implements PaymentPluginApi {

    public static final String PLUGIN_PROPERTY_PAYMENT_REFERENCE_NUMBER = "depositPaymentReferenceNumber";
    public static final String PLUGIN_PROPERTY_DEPOSIT_TYPE = "depositType";

    private final OSGIKillbillClock clock;

    public DepositPaymentPluginApi(final OSGIKillbillClock clock) {
        this.clock = clock;
    }
