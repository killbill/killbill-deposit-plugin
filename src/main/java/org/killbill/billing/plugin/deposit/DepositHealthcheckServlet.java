...
@Singleton
@Path("/healthcheck")
public class DepositHealthcheckServlet extends PluginHealthcheck {

    private final DepositHealthcheck healthcheck;

    @Inject
    public DepositHealthcheckServlet(final DepositHealthcheck healthcheck) {
